...
```{r green_certification how good}
forest_howgood
```
...
artialPlot(green_forest, green_test, 'green_rating', las=1)
```
...
The below fisrt map show clear clusters around San Francisco and Los Angeles in the raw house price data. In general, the forest model does a good job of capturing this trend. You can see this because the second map looks very similar to the first one. Also, the third map shows relatively low model error.
