...
```
=======
green_rating, being a bianary indicator variable, is associated with a linear shift in expected building value of about 30, which is quite unimpressive as a value generating feature. Unsuprisingly, it ranks very low on both the %IncMSE and node purity.
