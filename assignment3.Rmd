...
Some key analysis can be reaped from the following partial dependence plots. As longitude becomes less negative (moving eastward from the coast), predicted housing prices drop. 
...
The final PD plot shows how predictions change with median income. Tracts with higher median income have higher house prices, which is what we would expect. 
